...
import torchvision
__all__ = ['mobilenetv2_x1_0_v1', 'mobilenetv2_x1_4_v1']
...
class ConvBlock(nn.Module):
    ...
    convolution (bias discarded) + batch normalization + relu.
...
class MobileNetV2(nn.Module):
    ...
    Public keys:
        - ``mobilenetv2_x1_0_v1``: MobileNetV2 x1.0.
        - ``mobilenetv2_x1_4_v1``: MobileNetV2 x1.4.
    """
...
def mobilenetv2_x1_4_v1(num_classes, loss, pretrained=True, **kwargs):
    model = MobileNetV2(
        num_classes,
        loss=loss,
        width_mult=1.4,
